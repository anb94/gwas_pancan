...
awk '{if ($7 < 0.3) print $1}' ${WHI_SHARE_aa_c1}/SHAREchr${i}aa.info > ${WHI_SHARE_aa_cb}/SHAREchr${i}aa_lq03_snps.txt
awk '{if ($7 < 0.3) print $1}' ${WHI_SHARE_aa_c1}/SHAREchr${i}aa.info > ${WHI_SHARE_aa_cb}/SHAREchr${i}aa_lq08_snps.txt
done
...
awk '{if ($7 < 0.3) print $1}' ${WHI_SHARE_ha_c1}/SHAREchr${i}ha.info > ${WHI_SHARE_ha_cb}/SHAREchr${i}ha_lq08_snps.txt
done
echo "Completed Generating low quality SNPs for African Americans"
