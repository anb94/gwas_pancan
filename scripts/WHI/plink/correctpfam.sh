...
awk '{print $1,$2,$3,$4,2,$6}' ${WHI_SHARE_aa_cb}/SHAREchr1aa.pfam  > ${WHI_SHARE_aa_cb}/SHARE_aa.pfam
awk '{print $1,$2,$3,$4,2,$6}' ${WHI_SHARE_ha_cb}/SHAREchr1ha.pfam  > ${WHI_SHARE_ha_cb}/SHARE_ha.pfam